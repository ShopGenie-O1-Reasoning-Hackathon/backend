...
from app.core.qdrant import qdrantClient as qdrantClient_ShopGenie
from app.core.openai import openaiClient
from app.helpers.embedding_generate import get_image_embeddings
from app.schemas.product import ProductSchema
from app.core.config import settings

def get_search_products_from_image(image_url: str) -> List[ProductSchema]:
    embedding = get_image_embeddings(image_url)
